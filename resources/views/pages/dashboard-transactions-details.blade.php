                          ...
                          <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                              ...
                              <div class="product-subtitle text-danger">
                                <span class="{{ $transaction->transaction->transaction_status === "UNPAID" ? '' : 'd-none' }} text-secondary" >UNPAID</span>
                                <span class="{{ $transaction->transaction->transaction_status === "PENDING" ? '' : 'd-none' }} text-warning"" >PENDING</span>
                                <span class="{{ $transaction->transaction->transaction_status === "SHIPPING" ? '' : 'd-none' }} text-success"" >SHIPPING</span>
                                <span class="{{ $transaction->transaction->transaction_status === "SUCCESS" ? '' : 'd-none' }} text-success"" >SUCCESS</span>
                              </div>
                            </div>
                            <div class="col-12 col-md-6">
